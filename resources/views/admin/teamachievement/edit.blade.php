        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST"
                        action="{{ route('admin.teamachievements.update', ['teamachievement' => $achievement]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            ...
                            <x-select-input id="team_id" class="mt-1 block w-full" name="team_id">
